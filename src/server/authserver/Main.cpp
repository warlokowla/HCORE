...
extern int main(int argc, char **argv)
{
	...
	sLog->outInfo(LOG_FILTER_AUTHSERVER, " _     _  ______              ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "| |  | | |  ____|            ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "| |  | | | |             ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "| |- | | | |             ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "|  -   | | |____            ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "| |  | | |______|    HarDCore  REV 9.3 BY WILLIAMDEVS     ");
	sLog->outInfo(LOG_FILTER_AUTHSERVER, "");
