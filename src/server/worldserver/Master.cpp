...
int Master::Run()
{
	...
	sLog->outInfo(LOG_FILTER_WORLDSERVER, " _    _  _______              ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "| |  | | |  ____|            ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "| |  | | | |             ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "| |- | | | |             ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "|  -   | | |____            ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "| |  | | |______|    HarDCore  REV 10 BY WILLDEVS     ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, " -    -         ");

    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Todos los derechos reservados WillDEVS - WOWsource 2015");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "visita nuestra web www.asmodeoswow.tk");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Hardcore 2015 4.3.4 cataclysm");
